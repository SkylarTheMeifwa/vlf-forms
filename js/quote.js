document.addEventListener("DOMContentLoaded", function () {
    ...
    const quoteNumberPreview =
        document.getElementById("QuoteNumberPreview");
    ...
    year.addEventListener("input", updateQuoteNumber);
    seqNum.addEventListener("input", updateQuoteNumber);
    ...
    quoteForm.addEventListener(
        ...
        async function (event) {
            ...
            try {
                ...
                link.download = `${formData.INfinal} Quote.xlsx`;
                ...
                alert(
                    "There was a problem creating the quote.\n\n" +
                    error.message
                );
            }
        }
