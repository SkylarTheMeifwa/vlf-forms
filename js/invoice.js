document.addEventListener("DOMContentLoaded", function () {
    ...
    if (!invoiceForm) {
        console.error("InvoiceForm not found.");
        return;
    }
    ...
    const invoiceNumberPreview =
        document.getElementById("InvoiceNumberPreview");
    ...
    year.addEventListener("input", updateInvoiceNumber);
        ...
        async function (event) {
            ...
            try {
                ...
                const indexes = {
                    ...
                    FIdate: addSharedString(formData.FIdate),
                ...
                replaceBlankCellValue("I14", indexes.FIdate);
                ...
                link.download = `${formData.INfinal} Invoice.xlsx`;
                ...
                alert(
                    "There was a problem creating the invoice.\n\n" +
                    error.message
                );
            }
        }
